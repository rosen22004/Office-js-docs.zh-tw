# <a name="excel-javascript-api-programming-overview"></a>Excel JavaScript API 程式設計的概觀
...
### <a name="null-input-in-2-d-array"></a>2 維陣列中的 null 輸入
...
## <a name="unbounded-range"></a>未繫結的範圍
