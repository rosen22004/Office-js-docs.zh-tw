...
3. 取得您的 Azure 帳戶。
     ...
     >**附註：**如果您是 MSDN 訂閱者，[您的 MSDN 訂閱會包含 Azure 訂閱](http://www.windowsazure.com/en-us/pricing/member-offers/msdn-benefits/)。 如果您不是 MSDN 訂閱者，您仍然可以[ Windows Azure 網站免費試用 Azure](https://azure.microsoft.com/en-us/pricing/free-trial/)。 
...
1. 在 Visual Studio 的 [方案總管]**** 中有開啟的 Office 增益集範例，展開解決方案以顯示兩個專案。
...
- [使用 Napa 或 Visual Studio 封裝增益集以準備發佈](../publish/package-your-add-in-using-napa-or-visual-studio.md)
