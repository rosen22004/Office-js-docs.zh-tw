...
|[最低權限等級](../../../docs/outlook/understanding-outlook-add-in-permissions.md)| ReadItem|
|適用的 Outlook 模式| 撰寫|
####  <a name="setasyncsubject-options-callback"></a>setAsync(subject, [options], [callback])
