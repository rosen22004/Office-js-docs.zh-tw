...
# <a name="customxmlnode.nodetype-property"></a>CustomXmlNode.nodeType 屬性
取得 [CustomXMLNode](../../reference/shared/customxmlnode.customxmlnode.md) 的類型。
...
指定節點類型的 [CustomXMLNodeType](../../reference/shared/customxmlnodetype-enumeration.md)。
