...
|Baseline1FixedCost|71|適用於比較基準任務的任何非資源費用固定成本。|
...
|Baseline5FixedCostAccrual|108|定義如何比較基準任務累算固定成本的累算方法︰在任務開始時累算 = 1，在任務結束時累算 = 2，隨任務進行累算 (依比例) = 3。|
...
|Baseline9Start|145|比較基準任務的開始日期。|
...
|ID|219|所選任務的索引。專案摘要任務後，專案中第一個任務的索引為 1。|
|名稱|220|工作的名稱。|
