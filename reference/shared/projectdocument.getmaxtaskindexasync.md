...
# <a name="projectdocument.getmaxtaskindexasync-method"></a>ProjectDocument.getMaxTaskIndexAsync 方法
...
|[value](../../reference/shared/asyncresult.value.md)|在目前專案的工作集合中，最大的索引編號。|
