...
# <a name="customxmlpart.removehandlerasync-method"></a>CustomXmlPart.removeHandlerAsync 方法
移除 **CustomXmlPart** 物件事件的事件處理常式。
...
|**名稱**|**類型**|**描述**|**支援附註**|
|:-----|:-----|:-----|:-----|
| _eventType_|[EventType](../../reference/shared/eventtype-enumeration.md)|指定要移除事件的類型。必要。對於 **CustomXmlPart** 物件事件，_eventType_ 參數可指定為 **Office.EventType.DataNodeDeleted**、**Office.EventType.DataNodeInserted**、**Office.EventType.DataNodeReplaced**，或這些列舉的對應文字值。||
