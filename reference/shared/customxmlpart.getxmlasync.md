...
# <a name="customxmlpart.getxmlasync-method"></a>CustomXmlPart.getXmlAsync 方法
以非同步方式取得此自訂 XML 組件內的 XML。
...
在傳遞至 **getXmlAsync** 方法的回呼函數中，您可以使用 **AsyncResult** 物件的屬性以傳回下列資訊。



|**屬性**|**用於...**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|存取包含參考 **CustomXmlPart** 物件之 XML 的[字串](../../reference/shared/customxmlnode.getnodesasync.md)。|
