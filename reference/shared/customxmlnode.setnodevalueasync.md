...
# <a name="customxmlnode.setnodevalueasync-method"></a>CustomXmlNode.setNodeValueAsync 方法
以非同步方式設定節點的值。
...
在傳遞至 **setNodeValueAsync** 方法的回呼函數中，您可以使用 **AsyncResult** 物件的屬性以傳回下列資訊。
