...
# <a name="customxmlnode.setxmlasync-method"></a>CustomXmlNode.setXmlAsync 方法
設定節點的 XML。
...
|**名稱**|**類型**|**描述**|**支援附註**|
|:-----|:-----|:-----|:-----|
| _XML_|**string**|要新增之樹狀子目錄的 XML。必要。||
...
在傳遞至 **setXmlAsync** 方法的回呼函數中，您可以使用 **AsyncResult** 物件的屬性以傳回下列資訊。
