...
# Binding.removeHandlerAsync 方法
移除指定的事件類型繫結中所指定的處理常式。
...
|**名稱**|**類型	**|**說明**|**支援附註**|
|:-----|:-----|:-----|:-----|
| _eventType_|[EventType](../../reference/shared/eventtype-enumeration.md)|指定事件類型。必要。||
...
下列範例會移除名稱為 `onBindingDataChanged` 之 **BindingDataChanged** 事件的處理常式。
