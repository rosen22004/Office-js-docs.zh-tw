...
# <a name="matrixbinding.rowcount-property"></a>MatrixBinding.rowCount 屬性
以整數值在矩陣資料結構中，取得資料列的數目。
...
在指定之 [MatrixBinding](../../reference/shared/binding.matrixbinding.md) 物件中的資料列數目。
