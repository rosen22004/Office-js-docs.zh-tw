...
# <a name="customxmlnode.getnodevalueasync-method"></a>CustomXmlNode.getNodeValueAsync 方法
以非同步方式取得節點的值。
...
在傳遞至 **getNodeValueAsync** 方法的回呼函數中，您可以使用 **AsyncResult** 物件的屬性以傳回下列資訊。



|**屬性**|**用於...**|
|:-----|:-----|
|[AsyncResult.value](../../reference/shared/asyncresult.value.md)|存取包含參考節點的值的**字串**。|
