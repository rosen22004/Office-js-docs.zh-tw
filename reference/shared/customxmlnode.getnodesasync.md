...
# <a name="customxmlnode.getnodesasync-method"></a>CustomXmlNode.getNodesAsync 方法
取得節點，做為符合相對的 XPath 運算式的 **CustomXMLNode** 物件的陣列。
...
|**名稱**|**類型**|**描述**|**支援附註**|
|:-----|:-----|:-----|:-----|
| _xPath_|**string**|指定取得節點的 XPath 運算式。必要。||
