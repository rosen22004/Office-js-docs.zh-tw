# <a name="paragraphcollection-object-(javascript-api-for-word)"></a>ParagraphCollection 物件 (適用於 Word 的 JavaScript API)

包含 [paragraph](paragraph.md) 物件的集合。
...
| 屬性	     | 類型	   |描述
|:---------------|:--------|:----------|
|項目|[Paragraph[]](paragraph.md)|Paragraph 物件的集合。唯讀。|
