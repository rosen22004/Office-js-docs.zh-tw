# <a name="searchresultcollection-object-(javascript-api-for-word)"></a>SearchResultCollection 物件 (適用於 Word 的 JavaScript API)
...
| 屬性	     | 類型	   |描述
|:---------------|:--------|:----------|
|項目|[Range[]](range.md)|包含搜尋結果的 range 物件的集合。唯讀。|
